...
$(".slide_text_area").hide();

$(".slide3 .swiper-slide").mouseover(function(){
    $(this).find('.slide_text_area').stop().fadeIn();
});
$(".slide3 .swiper-slide").mouseleave(function(){
    $(this).find('.slide_text_area').stop().fadeOut();
});
...
$(".sec1_pagenumber li").eq(2).addClass("on");

$(".sec1_pagenumber li").click(function(){
    $(this).addClass("on").siblings().removeClass('on');
    $(this).find('svg path').attr('stroke','#fff');
    $(this).siblings().find('svg path').attr('stroke','#333');
